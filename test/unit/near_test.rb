...
class NearTest < GeocoderTestCase
  ...
  def test_near_scope_options_without_sqlite_includes_bounding_box_condition
    result = PlaceWithCustomResultsHandling.send(:near_scope_options, nil, 1.0, 2.0, 5)
  ...
  def test_near_scope_options_without_sqlite_includes_radius_condition
    result = Place.send(:near_scope_options, nil, 1.0, 2.0, 5)
  ...
  def test_near_scope_options_without_sqlite_includes_radius_custom_min_radius
    result = Place.send(:near_scope_options, nil, 1.0, 2.0, 5, :min_radius => 3)
  ...
  def test_near_scope_options_without_sqlite_includes_radius_bogus_min_radius
    result = Place.send(:near_scope_options, nil, 1.0, 2.0, 5, :min_radius => 'bogus')
  ...
  def test_near_scope_options_with_no_distance
    result = PlaceWithCustomResultsHandling.send(:near_scope_options, nil, 1.0, 2.0, 5, :select_distance => false)
  ...
  def test_near_scope_options_with_no_bearing
    result = PlaceWithCustomResultsHandling.send(:near_scope_options, nil, 1.0, 2.0, 5, :select_bearing => false)
  ...
  def test_near_scope_options_with_custom_distance_column
    result = PlaceWithCustomResultsHandling.send(:near_scope_options, nil, 1.0, 2.0, 5, :distance_column => 'calculated_distance')
  ...
  def test_near_scope_options_with_custom_bearing_column
    result = PlaceWithCustomResultsHandling.send(:near_scope_options, nil, 1.0, 2.0, 5, :bearing_column => 'calculated_bearing')
